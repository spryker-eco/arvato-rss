...
$config[ArvatoRssConstants::ARVATORSS] = [
    ...
    ArvatoRssConstants::ARVATORSS_URL => 'https://integration.risk-solution-services.de/rss-services/risk-solution-services.v2.1',
    ArvatoRssConstants::ARVATORSS_CLIENTID => '',
    ArvatoRssConstants::ARVATORSS_PASSWORD => '',
];
